 ...
 */
public class SqlDateTimeLiteral extends SqlAbstractDateTimeLiteral {
  //~ Constructors -----------------------------------------------------------

  SqlDateTimeLiteral(DateTimeString dt, int precision,
                     SqlTypeName typeName, SqlParserPos pos) {
    super(dt, false, typeName, precision, pos);
  ...
  @Override public SqlDateTimeLiteral clone(SqlParserPos pos) {
    return new SqlDateTimeLiteral(
        (DateTimeString) Objects.requireNonNull(value, "value"),
        precision,
        getTypeName(), pos);
  }
