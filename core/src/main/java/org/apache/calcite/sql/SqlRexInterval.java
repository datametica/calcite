 ...
 */
public class SqlRexInterval extends SqlNode {

  public SqlRexInterval(SqlParserPos pos, RexNode node, SqlIntervalQualifier intervalQualifier) {
    super(pos);
    this.node = node;
  ...
  @Override public SqlNode clone(SqlParserPos pos) {
    return new SqlRexInterval(pos, node, intervalQualifier);
  }

  @Override public SqlKind getKind() {
    return SqlKind.REX_INTERVAL;
  }
  ...
  @Override public void unparse(
      ...
      int leftPrec,
      int rightPrec) {
    writer.getDialect().unparseSqlRexInterval(writer, this, leftPrec, rightPrec);
  }

  @Override public void validate(SqlValidator validator, SqlValidatorScope scope) {
    validator.validateRexInterval(this);
  }
  ...
  @Override public boolean equalsDeep(@Nullable SqlNode node, Litmus litmus) {
    return node instanceof SqlRexInterval;
  }
}
