...
import static org.apache.calcite.sql.SqlDateTimeFormat.DDHH;
...
import static org.apache.calcite.sql.SqlDateTimeFormat.HHMMSS;
...
import static org.apache.calcite.sql.SqlDateTimeFormat.YYYYMMDDHHMMSS;
import static org.apache.calcite.sql.SqlDateTimeFormat.YYYYMMDDHHMMSSSSS;
...
public class BigQuerySqlDialect extends SqlDialect {
  ...
  private static final Map<SqlDateTimeFormat, String> DATE_TIME_FORMAT_MAP =
      new HashMap<SqlDateTimeFormat, String>() {{
        ...
        put(YYYYMMDDHHMMSSSSS, "%Y%m%d%H%M%E3S");
        put(U, "%u");
        put(DDHH, "%d%H");
      }};
