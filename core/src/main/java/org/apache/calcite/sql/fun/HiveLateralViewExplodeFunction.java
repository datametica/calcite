...
/**
 * class For Hive Lateral View Explode Function.
 */
public class HiveLateralViewExplodeFunction extends SqlFunction implements SqlTableFunction {

  private final Map<String, RelDataType> columnDefinitions;

  public HiveLateralViewExplodeFunction(Map<String, RelDataType> columnDefinitions) {
    super("LATERAL VIEW EXPLODE",
        SqlKind.OTHER_FUNCTION,
        ReturnTypes.COLUMN_LIST,
        null,
        OperandTypes.ARRAY_OR_MAP,
